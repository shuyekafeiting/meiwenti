            ...
            <div class="col-sm-12">
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                        <form method="post" class="form-horizontal" action="<?php echo U('editMarketHanddle');?>" onsubmit="return checkform(this)">
                            <div class="form-group">
                                <label class="col-sm-2 control-label">所属体系</label>

                                <div class="col-sm-10">
                                	<input type="hidden" name="id" value="<?php echo ($data["id"]); ?>">
                                    <input type="text" name="system" value="<?php echo ($data["system"]); ?>" class="form-control"> 
                                </div>
                            </div>
