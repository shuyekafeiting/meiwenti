                        ...
                        <form method="post" class="form-horizontal" action="<?php echo U('do_add');?>">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    ...
                                    <span class="help-block m-b-none">用来让管理员登陆的账号(一般填写管理员手机号即可)</span>
                                </div>
                            </div>
                            <div class="hr-line-dashed"></div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    ...
                                    <span class="help-block m-b-none">用来让管理员登陆的密码</span>
                                </div>
                            </div>
                            <div class="hr-line-dashed"></div>
                            <div class="form-group">
                                <label class="col-sm-2 control-label">隶属于的角色</label>
                                <div class="col-sm-10">
                                    <select class="form-control m-b" name="role">
                                    <option >选择所属角色</option>
                                    <?php if(is_array($role)): foreach($role as $key=>$role): ?><option value="<?php echo ($role["id"]); ?>"><?php echo ($role["name"]); ?></option><?php endforeach; endif; ?>
                                    </select>
                                    <span class="help-block m-b-none">必须要给管理员安排一个角色，管理员继承盖角色的权限</span>
                                </div>
                            </div>
                            <div class="hr-line-dashed"></div>
                            <div class="form-group">
