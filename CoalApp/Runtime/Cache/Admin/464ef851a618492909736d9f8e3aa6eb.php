            ...
            <div class="col-sm-12">
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                        <form method="post" class="form-horizontal" action="<?php echo U('editPowerHanddle');?>" onsubmit="return checkform(this)">
                            <div class="form-group">
                                <label class="col-sm-2 control-label">电厂名字</label>
                                <div class="col-sm-10">
                                <input type="hidden" name="id" value="<?php echo ($power["id"]); ?>"/>
                                <input type="text" name="name" value="<?php echo ($power["name"]); ?>" class="form-control"> 
                                </div>
                            </div>
                            <div class="hr-line-dashed"></div>
                            <div class="form-group">
                                <label class="col-sm-2 control-label">电厂图片</label>
                                <input type="hidden" name="picture" value="<?php echo ($power["picture"]); ?>"/>
                                <input type="hidden" name="litpic" value="<?php echo ($power["litpic"]); ?>"/>
                                <div class="col-sm-10">
                                   <div id="uploader"  class="wu-example">
                                                        <div class="queueList">
                                                            <div id="dndArea" style="padding-top:10px; min-height:80px;" class="placeholder">
                                                            	<img src="<?php echo ($power["true_pic"]); ?>" id='true_pic'/>
                            ...
                            <div class="hr-line-dashed"></div>
                            <div class="form-group">
                                <label class="col-sm-2 control-label">电厂库存</label>
                                <div class="col-sm-10">
                                	<input type="text" name="inventory" value="<?php echo ($power["inventory"]); ?>" class="form-control"/> 
                                    <span class="help-block m-b-none">万吨</span>
                                </div>
                            </div>
                            <div class="hr-line-dashed"></div>
                            <div class="form-group">
                                <label class="col-sm-2 control-label">日耗</label>
                                <div class="col-sm-10">
                                	<input type="text" name="daily" value="<?php echo ($power["daily"]); ?>" class="form-control"/> 
                                    <span class="help-block m-b-none">万吨</span>
                                </div>
                            </div>
