            ...
            <div class="col-sm-12">
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                        <form method="post" class="form-horizontal" action="<?php echo U('editRoleHanddle');?>">
                            ...
                            <div class="form-group">
                                ...
                                <?php if(is_array($user_auth_level1)): foreach($user_auth_level1 as $key=>$vo1): ?><div class="checkbox_div">
                                    <label style="font-weight:bold" class="checkbox-inline i-checks level1_auth">
                                        <input type="checkbox"  <?php if($vo1['is_awllo']): ?>checked<?php endif; ?>  class="level1_auth_value"  name='role_auth[]'  value="<?php echo ($vo1["id"]); ?>">
                                        ...
                                        <?php if(is_array($user_auth_level2)): foreach($user_auth_level2 as $key=>$vo2): if($vo2['aid'] == $vo1['id']): ?><label style="font-weight:normal">
                                                <input type="checkbox" <?php if($vo2['is_awllo']): ?>checked<?php endif; ?>  class="level2_auth" name='role_auth[]' value="<?php echo ($vo2["id"]); ?>">
