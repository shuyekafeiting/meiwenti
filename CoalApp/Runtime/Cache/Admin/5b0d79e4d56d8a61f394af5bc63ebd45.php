                    ...
                    <div class="ibox-content">
                        <form method="post" class="form-horizontal" action="<?php echo U('editHanddle');?>" onsubmit="return checkform(this)">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" name="name" value="<?php echo ($trucker["name"]); ?>" class="form-control"> 
                                </div>
                            </div>
                            <div class="hr-line-dashed"></div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input type="hidden" id="idcard_pic" name="idcard_pic" value="<?php echo ($trucker["idcard_pic"]); ?>"/>
                                <input type="hidden" id="idcard_lit" name="idcard_lit"/>
                                <?php if($trucker['idcard_pic']): ?><div class="col-sm-10 idcard_div" style="display:none">
                                    ...
                                    <div class="col-sm-10 idcard_img_div" style="display:block">
                                     <img class="idcard_img" id="idcard_img" src="/Public/u_img/<?php echo ($trucker["idcard_pic"]); ?>"> 
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                	<input type="text" name="idcard_num" value="<?php echo ($trucker["idcard_num"]); ?>" class="form-control"> 
                                </div>
                            </div>
                            <div class="hr-line-dashed"></div>
                            <div class="form-group">
                                <label class="col-sm-2 control-label">驾驶证</label>
                                <input type="hidden" id="lic_pic" name="lic_pic" value="<?php echo ($trucker["lic_pic"]); ?>"/>
                                <input type="hidden" id="lic_lit" name="lic_lit"/>
                                <?php if($trucker['lic_pic']): ?><div class="col-sm-10 lic_div" style="display:none;">
                                        <i class="iconfont lic_ico"  >&#xe609;</i>
                                    ...
                                    <div class="col-sm-10 lic_img_div" style="display:block;">
                                     <img class="lic_img" id="lic_img" src="/Public/u_img/<?php echo ($trucker["lic_pic"]); ?>"> 
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                	<input type="text" name="lic_number" value="<?php echo ($trucker["lic_number"]); ?>" class="form-control"> 
                                </div>
                            </div>
                            <div class="hr-line-dashed"></div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-3">
                                	 <select class="form-control m-b" id="address_p" name="lic_level">
                                     		<?php if($trucker['lic_level'] == 'A'): ?><option value="A" selected>A</option>
                                            <?php else: ?>
                                            	<option value="A" >A</option><?php endif; ?>
                                            <?php if($trucker['lic_level'] == 'B'): ?><option value="B" selected>B</option>
                                            <?php else: ?>
                                            	<option value="B" >B</option><?php endif; ?>
                                            <?php if($trucker['lic_level'] == 'C'): ?><option value="C" selected>C</option>
                                            <?php else: ?>
