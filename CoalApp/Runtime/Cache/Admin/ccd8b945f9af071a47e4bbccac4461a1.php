    ...
    <script>
        $(document).ready(function () {
           $.jgrid.defaults.styleUI = 'Bootstrap';  
            ...
            $("#table_list_1").jqGrid({
				url:"<?php echo U('Seller/ajaxListIspassed/');?>",
                data: {},
                datatype: "json",
				mtype: 'POST',
				loadonce: false,
                ...
                rowNum: 10,
                rowList: [10, 20, 30],
                colNames: ['ID', '卖家名称','手机号', '注册日期', '省','市','区','详细地址', '操作'],
                colModel: [
                ...
                pager: "#pager_list_1",
                viewrecords: true,
                caption: "<?php echo ($this_auth["name"]); ?>&nbsp;&nbsp;<a href='<?php echo U('addSeller');?>' style='align:right'>+新增卖家</a>",
                hidegrid: false,
            });
