    ...
    <script>
        $(document).ready(function () {
           $.jgrid.defaults.styleUI = 'Bootstrap';  
            ...
            $("#table_list_1").jqGrid({
				url:"<?php echo U('News/listAjaxPower');?>",
                data: {},
                datatype: "json",
				mtype: 'POST',
				loadonce: false,
                ...
                rowNum: 10,
                rowList: [10, 20, 30],
                colNames: ['ID', '电厂名字', '更新日期', '库存', '日耗量', '操作'],
                colModel: [
                    ...
                    {name: 'daily',index: 'daily',width: 80,align: "left",sorttype: "int",align: "center" },
					
                    {name: 'dostr',index: 'dostr',width: 80,align: "center"}
                ],
                pager: "#pager_list_1",
                viewrecords: true,
                caption: "<?php echo ($this_auth["name"]); ?>&nbsp;&nbsp;<a href='<?php echo U('addPower');?>' style='align:right'>+新增电厂</a>",
                hidegrid: false,
            });
