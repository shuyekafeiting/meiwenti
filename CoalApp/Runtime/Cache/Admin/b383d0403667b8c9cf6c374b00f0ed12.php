...
<body class="gray-bg">
            ...
            <div class="col-sm-12">
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                        <form method="post" class="form-horizontal" action="<?php echo U('editNewsHanddle');?>" onsubmit="return checkform(this)">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" name="source" class="form-control" value="<?php echo ($new["source"]); ?>"> 
                                </div>
                            </div>
                            <div class="hr-line-dashed"></div>
                            <div class="form-group">
                                <label class="col-sm-2 control-label">文章图片</label>
                                <input type="hidden" name="picture" value="<?php echo ($new["picture"]); ?>"/>
                                <input type="hidden" name="litpic" value="<?php echo ($new["litpic"]); ?>"/>
                                <input type="hidden" name="click" value="<?php echo ($new["click"]); ?>"/>
                                ...
                                <div class="col-sm-10">
                                   ...
                                   <div id="uploader"  class="wu-example">
                                                        <div class="queueList">
                                                            ...
                                                            <img src="<?php echo ($new["true_pic"]); ?>" id='true_pic'/>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                	<textarea type="text" name="des" class="form-control"><?php echo ($new["description"]); ?> </textarea>
                                </div>
                            </div>
                            <div class="hr-line-dashed"></div>
                            <div class="form-group">
  ...
  <!-- Web Uploader -->
    ...
    <script src="/Public/hplus/js/demo/webuploader-editnews.js"></script>
</body>
</html>