    ...
    <script>
        $(document).ready(function () {
           $.jgrid.defaults.styleUI = 'Bootstrap';  
            ...
            $("#table_list_1").jqGrid({
				url:"<?php echo U('News/listAjaxShip');?>",
                data: {},
                datatype: "json",
				mtype: 'POST',
				loadonce: false,
                ...
                rowNum: 10,
                rowList: [10, 20, 30],
                colNames: ['ID', '起始地', '终点','更新时间', '船型', '运费', '变化','操作'],
                colModel: [
                    {name: 'id',index: 'id',width: 60,sorttype: "int",align: "center"},
					
                    {name: 'from',index: 'from',width: 90,sorttype: "string",formatter: "string",stype:'string',align: "center"},
					
                   	 {name: 'to',index: 'to',width: 50,align: "center",sorttype: "string",stype:'string'},
					 {name: 'update_time',index: 'update_time',width: 50,align: "center",sorttype: "date",stype:'date'},
					
                    {name: 'ship', index: 'ship',width: 80,align: "center",sorttype: "string"},
					
                    {name: 'price',index: 'price',width: 80,align: "left",sorttype: "double",formatter: "double",stype:'double',align: "center" },
                ...
                pager: "#pager_list_1",
                viewrecords: true,
                caption: "<?php echo ($this_auth["name"]); ?>&nbsp;&nbsp;<a href='<?php echo U('addShip');?>' style='align:right'>+新增数据</a>",
                hidegrid: false,
            });
