    ...
    <script>
        $(document).ready(function () {
           $.jgrid.defaults.styleUI = 'Bootstrap';  
            ...
            $("#table_list_1").jqGrid({
				url:"<?php echo U('News/listAjaxMarket');?>",
                data: {},
                datatype: "json",
				mtype: 'POST',
				loadonce: false,
                ...
                rowNum: 10,
                rowList: [10, 20, 30],
                colNames: ['ID', '体系', '名称','更新时间', '价格', '变化','操作'],
                colModel: [
                    {name: 'id',index: 'id',width: 60,sorttype: "int",align: "center"},
					
                    {name: 'system',index: 'system',width: 90,sorttype: "string",formatter: "string",stype:'string',align: "center"},
					
                   	 {name: 'name',index: 'name',width: 50,align: "center",sorttype: "string",stype:'string'},
                ...
                pager: "#pager_list_1",
                viewrecords: true,
                caption: "<?php echo ($this_auth["name"]); ?>&nbsp;&nbsp;<a href='<?php echo U('addMarket');?>' style='align:right'>+新增数据</a>",
                hidegrid: false,
            });
