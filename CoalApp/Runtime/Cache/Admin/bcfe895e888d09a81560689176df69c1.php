    ...
    <script>
        $(document).ready(function () {
           $.jgrid.defaults.styleUI = 'Bootstrap';  
            ...
            $("#table_list_1").jqGrid({
				url:"<?php echo U('Role/listRoleAjax');?>",
                data: {},
                datatype: "json",
				mtype: 'POST',
				loadonce: false,
                ...
                colModel: [
                    ...
                    {name: 'auth',index: 'auth',width: 50,align: "center",sorttype: "date",stype:'date'},
                ...
                pager: "#pager_list_1",
                viewrecords: true,
                caption: "新闻列表&nbsp;&nbsp;<a href='<?php echo U('add');?>' style='align:right'>+新增角色</a>",
                hidegrid: false,
            });
