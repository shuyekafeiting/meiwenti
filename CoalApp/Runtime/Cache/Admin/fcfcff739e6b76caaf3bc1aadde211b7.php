            ...
            <div class="col-sm-12">
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                        <form method="post" class="form-horizontal" action="<?php echo U('editPortHanddle');?>" onsubmit="return checkform(this)">
                            <div class="form-group">
                                <label class="col-sm-2 control-label">港口名字</label>
                                <div class="col-sm-10">
                            ...
                            <div class="hr-line-dashed"></div>
                            <div class="form-group">
                                <label class="col-sm-2 control-label">港口库存</label>
                                <div class="col-sm-10">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                	<input type="text" name="in_out" value="<?php echo ($power["in_out"]); ?>" class="form-control"/> 
                                    <span class="help-block m-b-none">万吨</span>
                                </div>
                            </div>
