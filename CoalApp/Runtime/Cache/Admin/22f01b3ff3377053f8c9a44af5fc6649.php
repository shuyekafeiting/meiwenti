...
<body class="gray-bg">
            ...
            <div class="col-sm-12">
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                        <form method="post" class="form-horizontal" action="<?php echo U('editSellerHanddle');?>" onsubmit="return checkform(this)">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" name="name" value="<?php echo ($seller["name"]); ?>" class="form-control"> 
                                </div>
                            </div>
                            <div class="hr-line-dashed"></div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input type="hidden" id="lic_pic" name="lic_pic" value="<?php echo ($seller["lic_pic"]); ?>"/>
                                <input type="hidden" id="lic_lit" name="lic_lit"/>
                                <?php if($seller['lic_pic']): ?><div class="col-sm-10 lic_div" style="display:none;">
                                    ...
                                    <div class="col-sm-10 lic_img_div" style="display:block;">
                                     <img class="lic_img" id="lic_img" src="/Public/u_img/<?php echo ($seller["lic_pic"]); ?>"> 
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                	<input type="text" name="lic_number" value="<?php echo ($seller["lic_number"]); ?>" class="form-control"> 
                                </div>
                            </div>
                            <div class="hr-line-dashed"></div>
                            <div class="form-group">
    ...
    <script>
		 var gps_x="<?php echo ($gps["x"]); ?>";
		 var gps_y="<?php echo ($gps["y"]); ?>";
		 if(!gps_x){
			 gps_x=116.39;
			 }
		 if(!gps_y){
