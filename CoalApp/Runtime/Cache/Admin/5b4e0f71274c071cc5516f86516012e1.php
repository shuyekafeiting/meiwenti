            ...
            <div class="col-sm-12">
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                        <form method="post" class="form-horizontal" action="<?php echo U('addHanddle');?>" onsubmit="return checkform(this)">
                        	<div class="form-group">
                                <label class="col-sm-2 control-label">注册账号</label>
                                <div class="col-sm-10">
                                    <input type="text" name="acc" class="form-control"> 
                                    <span class="help-block m-b-none">客户用来登录的手机号</span>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    ...
                                    <input type="radio" name="is_lock" id="is_lock_no" class="form" checked value="0">
                                    <label for="is_lock_yes" class="control-label">是</label>
                                    <input type="radio" name="is_lock" id="is_lock_yes"  class="form" value="1">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-2" >
                                    <select class="form-control m-b" id="address_s" name="address_s">
                                    </select> 
                                </div>
                                <div class="col-sm-2" >
                                    <select class="form-control m-b" id="address_q" name="address_q">
                                    </select> 
                                </div>
                                <div class="col-sm-2" >
                                    <input type="text" class="form-control m-b" id="address_d" name="address_d" placeholder="详细地址"/>
                                </div>
                            </div>
                            <div class="hr-line-dashed"></div>
                            <div class="form-group">
                                <label class="col-sm-2 control-label">头像</label>
                                <input type="hidden" id="photo_pic" name="photo_pic"/>
                                <input type="hidden" id="photo_lit" name="photo_lit"/>
                            ...
                            <div class="form-group">
                                ...
                                <input type="hidden" id="idcard_pic" name="idcard_pic"/>
                                ...
                                <div class="col-sm-10 idcard_img_div">
                                 <img class="idcard_img" id="idcard_img" src="/./CoalApp/Admin/Public/images/meikuang.jpg"> 
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                	<input type="text" name="idcard_num" class="form-control"> 
                                </div>
                            </div>
                            <div class="hr-line-dashed"></div>
                            <div class="form-group">
                                <label class="col-sm-2 control-label">驾驶证</label>
                                <input type="hidden" id="lic_pic" name="lic_pic"/>
                                ...
                                <div class="col-sm-10 lic_div">
                                    ...
                                    <input type="file" name="licpic" onchange="ajaxFileUpload1(this)" id="lic_file" class="lic_file" />
                                     <span class="help-block m-b-none">如果车主有驾驶证的话需要填写，可以绑定车辆，如果没有可以不用填写</span>
                                </div>
                            ...
                            <div class="hr-line-dashed"></div>
                            <div class="form-group">
                                <label class="col-sm-2 control-label">驾驶证号码</label>
                                <div class="col-sm-10">
