        ...
        <div class="ibox-content">
            <form method="post" class="form-horizontal" action="<?php echo U('addHanddle');?>">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <input id="gps1" type="hidden" name="gps1" value="<?php echo ($gps1["x"]); ?> <?php echo ($gps1["y"]); ?>"/>
                        <input id="address1" class="col-sm-5 form-control" value="" name="address1"/>
                        <div class="hr-line-dashed"></div>
...
<script>
    ...
    var gps = document.getElementById('gps1');
    var searchinput = document.getElementById('address1');
        ...
        map.on('click',function(e){
            ...
            geocoder.getAddress(e.lnglat,function(status,result){
                if(status=='complete'){
                    ...
                    document.getElementById('message1').innerHTML  = '无法获取地址'
                }
            })
        })
        ...
        searchinput.onchange = function(e){
            ...
            geocoder.getLocation(address,function(status,result){
                if(status=='complete'&&result.geocodes.length){
                    ...
                    document.getElementById('message1').innerHTML = '自动定位失败，请更换地址输入，或者手动选择'
                }
            })
        }
        ...
        $('#address_p').change(function(){
            $.post(
                    ...
                    function(data){
                        ...
                        //地图定位
                        address=$("#address_p").val();
                        searchinput = document.getElementById('address1');
                        searchinput.value=address;
                        searchinput.onchange();
